...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VideoFeed', function() {
      beforeEach(function() {
        instance = new LoaderoController.VideoFeed();
      });

      it('should create an instance of VideoFeed', function() {
        // TODO: update the code to test VideoFeed
        expect(instance).to.be.a(LoaderoController.VideoFeed);
      });
