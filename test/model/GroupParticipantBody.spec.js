...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupParticipantBody', function() {
      beforeEach(function() {
        instance = new LoaderoController.GroupParticipantBody();
      });

      it('should create an instance of GroupParticipantBody', function() {
        // TODO: update the code to test GroupParticipantBody
        expect(instance).to.be.a(LoaderoController.GroupParticipantBody);
      });
