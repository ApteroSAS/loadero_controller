...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AudioFeed', function() {
      beforeEach(function() {
        instance = new LoaderoController.AudioFeed();
      });

      it('should create an instance of AudioFeed', function() {
        // TODO: update the code to test AudioFeed
        expect(instance).to.be.a(LoaderoController.AudioFeed);
      });
