...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FullProject', function() {
      beforeEach(function() {
        instance = new LoaderoController.FullProject();
      });

      it('should create an instance of FullProject', function() {
        // TODO: update the code to test FullProject
        expect(instance).to.be.a(LoaderoController.FullProject);
      });
      ...
      it('should have the property computeUnitUsage (base name: "compute_unit_usage")', function() {
        // TODO: update the code to test the property computeUnitUsage
        expect(instance).to.have.property('computeUnitUsage');
        // expect(instance.computeUnitUsage).to.be(expectedValueLiteral);
      });
