...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ComputeUnit', function() {
      beforeEach(function() {
        instance = new LoaderoController.ComputeUnit();
      });

      it('should create an instance of ComputeUnit', function() {
        // TODO: update the code to test ComputeUnit
        expect(instance).to.be.a(LoaderoController.ComputeUnit);
      });
