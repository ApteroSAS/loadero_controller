...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResultStatus', function() {
      beforeEach(function() {
        instance = new LoaderoController.ResultStatus();
      });

      it('should create an instance of ResultStatus', function() {
        // TODO: update the code to test ResultStatus
        expect(instance).to.be.a(LoaderoController.ResultStatus);
      });
