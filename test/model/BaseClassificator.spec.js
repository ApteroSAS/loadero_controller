...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseClassificator', function() {
      beforeEach(function() {
        instance = new LoaderoController.BaseClassificator();
      });

      it('should create an instance of BaseClassificator', function() {
        // TODO: update the code to test BaseClassificator
        expect(instance).to.be.a(LoaderoController.BaseClassificator);
      });
