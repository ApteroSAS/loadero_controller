...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RunParticipant', function() {
      beforeEach(function() {
        instance = new LoaderoController.RunParticipant();
      });

      it('should create an instance of RunParticipant', function() {
        // TODO: update the code to test RunParticipant
        expect(instance).to.be.a(LoaderoController.RunParticipant);
      });
