...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SimpleProject', function() {
      beforeEach(function() {
        instance = new LoaderoController.SimpleProject();
      });

      it('should create an instance of SimpleProject', function() {
        // TODO: update the code to test SimpleProject
        expect(instance).to.be.a(LoaderoController.SimpleProject);
      });
